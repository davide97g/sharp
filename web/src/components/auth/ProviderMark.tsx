// Third-party sign-in brand marks, shared by the login screen and
// Settings → Accounts so the two never drift.
//
// The one sanctioned exception to the design system's no-hard-coded-hex rule:
// Google's mark is trademarked in its own four colours and must not be recoloured
// by the active theme. GitHub's is monochrome, so it takes currentColor.

import type { OAuthProvider } from '../../lib/types'

export const PROVIDER_ORDER: OAuthProvider[] = ['google', 'github']
