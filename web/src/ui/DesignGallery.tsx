...
const ICONS: { name: string; Comp: ComponentType<IconProps> }[] = [
  ...
  { name: 'DocIcon', Comp: DocIcon },
  { name: 'CanvasIcon', Comp: CanvasIcon },
  { name: 'BoardIcon', Comp: BoardIcon },
  { name: 'MessageIcon', Comp: MessageIcon },
  { name: 'SendIcon', Comp: SendIcon },
  { name: 'GithubIcon', Comp: GithubIcon },
  { name: 'ExpandIcon', Comp: ExpandIcon },
  { name: 'ShrinkIcon', Comp: ShrinkIcon },
